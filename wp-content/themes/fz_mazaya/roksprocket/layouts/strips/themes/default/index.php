...
<div class="sprocket-strips" data-strips="<?php echo $parameters->get('module_id'); ?>">
	...
	<div class="sprocket-strips-nav">
		...
		<div class="sprocket-strips-arrows">
			<span class="arrow next" data-strips-next><span><i class="icon-double-angle-right"></i></span></span>
			<span class="arrow prev" data-strips-previous><span><i class="icon-double-angle-left"></i></span></span>
		</div>
		<?php endif; ?>
	</div>
</div>
