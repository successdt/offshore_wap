...
// add css/js
		...
		wp_enqueue_script('warp-js-spectrumy', get_template_directory_uri() . '/warp/config/js/spectrum.js', false, '1.1', true );
		wp_enqueue_style('warp-css-spectrum', preg_replace($siteurl, '', $this['path']->url('config:css/spectrum.css'), 1));

		
		
			wp_enqueue_script('warp-js-widget', get_template_directory_uri() . '/warp/config/js/jquery.ui.widget.js', false, '1.1', true );
	wp_enqueue_script('warp-js-button', get_template_directory_uri() . '/warp/config/js/jquery.ui.button.js', false, '1.1', true );
	
	wp_enqueue_script('warp-js-spinner', get_template_directory_uri() . '/warp/config/js/jquery.ui.spinner.js', false, '1.1', true );
						
						
						
						
						
/*	wp_enqueue_script('warp-js-spectrum', preg_replace($siteurl, '', $this['path']->url('config:js/spectrum.js'), 1));*/
	
	
	 wp_enqueue_style('warp-css-jquery.ui.all', preg_replace($siteurl, '', $this['path']->url('config:css/jquery.ui.all.css'), 1));
	...
	*/
	public function _adminMenu() {
		...
		$icon = $this['path']->url('config:images/mazaya_icon_16.png');
