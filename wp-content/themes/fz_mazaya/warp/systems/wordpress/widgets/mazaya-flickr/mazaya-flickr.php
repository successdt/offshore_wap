...
class flickr_photos extends WP_Widget {
	...
	function flickr_photos() {
		$widget_ops = array('classname' => 'flickr-widget','description' => __('display photos from your account in flickr'));
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'flickr_photos-widget' );
		$this->WP_Widget('Mazaya_flickr',__('Mazaya - Flickr','warp'),$widget_ops);	}
	...
	function form( $instance ) {
		$defaults = array( 'flickr_title' =>__( 'Flickr' , 'warp'), 'no_of_photos' => '6' , 'flickr_display' => 'latest' );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'flickr_display' ); ?>">Sprting </label>
