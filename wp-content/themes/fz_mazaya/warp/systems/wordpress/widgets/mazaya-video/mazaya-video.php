...
class video_widget extends WP_Widget {
	...
	function video_widget() {
		$widget_ops = array('classname' => 'video-widget','description' => __('Widget display video support Youtube, vimeo, dailymotion','warp'));
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'video-widget' );
			$this->WP_Widget('video-widget',__('Mazaya - Video','warp'),$widget_ops);	}
	...
	function form( $instance ) {
		$defaults = array( 'title' =>__(' Featured Video', 'warp') );
