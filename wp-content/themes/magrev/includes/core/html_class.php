	...
	function generator($field, $settings, $user_settings, $return = 'html')
	{
		...
		switch($settings['type'])
		{
			...
			case "textarea":
				...
				$html['element'] = form_textarea(array_merge(array('name'=>$field,'value'=>$this->_webnukes->validation->set_value($field, htmlentities($settingsvalue)),'id'=>$field), (array) $settings['attrs']));
			break;
