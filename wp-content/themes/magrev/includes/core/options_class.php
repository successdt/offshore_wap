...
class fw_options_class
{
	...
	function __construct()
	{
		...
		{
			$this->get_options(); /** Get current settings */		
	...
	function generate_html()
	{
		...
		include( get_template_directory().'/includes/config/theme_options.php');
		$data['side_links'] = $this->_webnukes->html->layout('theme_options/left', array('options'=>$section, 'section', $this->section), true); /** Load the side links **/
