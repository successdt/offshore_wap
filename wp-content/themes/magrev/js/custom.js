...
jQuery(document).ready(function($) {
    ...
    if($( '#carousel1' ).length > 0) $( '#carousel1' ).elastislide();
    if($( '#carousel2' ).length > 0) $( '#carousel2' ).elastislide();
    ...
    $('#product_tabs ul.clearfix li  ').each(function(){
...
//    $( "#accordion" ).accordion();
	...
	$('.rating').raty({
		...
		$.post(fw_ajax, data, function(response) { });
		$(this).find('img').unbind('click');
		}
	});		
	
	$('#fw_contact_form').submit(function(e) {
        e.preventDefault();
	...
	$.prettyLoader();
	//$.prettyLoader.show();
	//$('body').append('<div class="fw-loading-wrapper"></div><div class="fw-loading-icon"></div>');			
...
tpj(document).ready(function() {
    ...
    if (tpj.fn.cssOriginal!==undefined)   // CHECK IF fn.css already extended
       ...
       if ( tpj.isFunction(tpj.fn.revolution) ) {
