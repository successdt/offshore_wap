...
/** Adding Shortcode button to WP editor, generating a popup to show a list of shorcodes to be inserted into WP editor */
class FW_Shortcoder
{
	...
	{
	   $plugin_array['fwbutton'] = get_template_directory_uri() . '/js/editor_plugin.js';
	   return $plugin_array;
	}
	...
	/*function admin_css()
	{
		//wp_enqueue_style('shortcoder-admin-css', get_template_directory_uri() . '/libs/css/admin-css.css');
	}
