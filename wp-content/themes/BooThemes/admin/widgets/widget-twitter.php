...
class fp_twitter_widget extends WP_Widget {
	...
	function fp_twitter_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'fp_twitter_widget', __('boothemes: Twitter', 'fp_twitter_widget'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Latest from Twitter', 'boothemes'), 'number' => 3, 'text' => __('Follow us on Twitter', 'boothemes'));
