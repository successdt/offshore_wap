...
class fp_recent_posts_widget extends WP_Widget {
	...
	function fp_recent_posts_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'fp_recent_posts_widget', __('boothemes: Recent posts', 'fp_recent_posts_widget'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Recent Posts', 'boothemes'), 'categories' => 'all', 'number' => 5);
