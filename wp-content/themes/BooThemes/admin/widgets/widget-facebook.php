...
class fp_facebook_widget extends WP_Widget {
	...
	function fp_facebook_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'fp_facebook_widget', __('boothemes: Facebook Like Box', 'fp_facebook_widget'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => 'Find us on Facebook', 'width' => 270, 'height' => 310, 'header' => 'on', 'faces' => 'on');
		...
		<p>
			...
			<small>Note: If using this widget in the footer you should enter 216 in width</small>
		</p>
		...
		<!-- Color -->
		<p>
			<label for="<?php echo $this->get_field_id( 'color' ); ?>">Colorscheme:</label>
