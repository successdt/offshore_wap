...
class fp_flickr_widget extends WP_Widget {
	...
	function fp_flickr_widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'fp_flickr_widget', __('boothemes: Flickr', 'fp_flickr_widget'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('My Photostream', 'boothemes'), 'postcount' => 6, 'type' => 'user', 'display' => 'random',);
