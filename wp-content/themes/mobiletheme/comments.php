...
<div class="comments-box"> <a name="comments" id="comments"></a>
  ...
  <div id="respond">
    ...
    <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
      ...
      <?php else : ?>
      <p>
        <input class="author" type="text" value="Tên bạn..." onfocus="if (this.value == 'Tên bạn...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Tên bạn...';}" name="author" id="author" size="22" tabindex="1"/><label for="author"><small><?php if ($req) echo "(<font color='red'>*</font>)"; ?></small></label>
      </p>
      <p>
        <input class="email" type="text" value="Email..." onfocus="if (this.value == 'Email...') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Email...';}" name="email" id="email" size="22" tabindex="2"/><label for="email"><small><?php if ($req) echo " (<font color='red'>*</font>)"; ?></small></label>
      </p>
      <p>
      ...
      <p>
        <input class="submit" name="submit" type="submit" id="submit" tabindex="5" value="Gửi bình luận" />
